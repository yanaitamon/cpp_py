================================================================================
MICROSOFT FOUNDATION CLASS ライブラリ: anotherone プロジェクトの概要
===============================================================================

アプリケーション ウィザードが作成した anotherone には Microsoft 
Foundation Class の基本的な使い方が示されています。アプリケーション作成のひな型
としてお使いください。

このファイルには anotherone アプリケーションを構成している各ファイ
ルの概要説明が含まれます。
...
anotherone.h
   ...
   CanotheroneApp アプリケーション クラスを宣言します。

anotherone.cpp
   これは、アプリケーション クラス CanotheroneApp を含むメイン アプリケー
   ション ソース ファイルです。
...
res\anotherone.ico
   ...
   アイコンはメイン リソース ファイル anotherone.rc に含まれていま
   す。
...
anotheroneDlg.h, anotheroneDlg.cpp - ダイアログ
   これらのファイルは CanotheroneDlg クラスを含みます。このクラスはアプ
   リケーションのメイン ダイアログの動作を定義します。ダイアログ テンプレートは
   Microsoft Visual C++ で編集可能な anotherone.rc に含まれます。
...
StdAfx.h, StdAfx.cpp
   ...
   anotherone.pch や既にコンパイルされた型のファイル StdAfx.obj を
   ビルドするために使用されます。
